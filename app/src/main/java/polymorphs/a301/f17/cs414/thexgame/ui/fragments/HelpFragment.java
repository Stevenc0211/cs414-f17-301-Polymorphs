...
/**
 * Created by steve-0 on 11/12/17. Pushed up by Roger do to weird git errors on Steven's machine. ~Roger
 */
...
public class HelpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textView.setMovementMethod(new ScrollingMovementMethod()); // this gets the textview to be scrollable for help
        return helpUI;
    }
